        ...
        <div className="profile-header">
            ...
            <div className="profile-header-content">
                ...
                <div className="profile-header-info">
                    <h4 className="m-t-sm">John Doe</h4>
                    <p className="m-b-sm">UXUI + Frontend Developer</p>
                    <a href="#" className="btn btn-xs btn-info mb-4">Edit Profile</a>
                </div>
            </div>
            ...
            <ul className="profile-header-tab nav nav-tabs">
                ...
                <li className="nav-item"><a href="#profile-videos" className="nav-link active show" data-toggle="tab">VIDEOS</a></li>
                ...
                <div className="col-md-8">
                    <div className="tab-content p-0">
                        <div className="tab-pane active show" id="profile-videos">
                            <div className="m-b-10"><b>Videos (15)</b></div>
                            ...
                            <div className="row row-space-2">
                                <div className="col-sm-4">
                                    <div className="embed-responsive embed-responsive-16by9 m-b-2">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/LbpHB9wbDhY?showinfo=0"></iframe>
                                    </div>
                                </div>
    
                                <div className="col-sm-4">
                                    <div className="embed-responsive embed-responsive-16by9 m-b-2">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/oVWBFkaXMyw?showinfo=0"></iframe>
                                    </div>
                                </div>
    
                                <div className="col-sm-4">
                                    <div className="embed-responsive embed-responsive-16by9 m-b-2">
                                        <iframe className="embed-responsive-item" src="https://www.youtube.com/embed/90PRvlhOLSk?showinfo=0"></iframe>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="col-md-4 hidden-xs hidden-sm">
                    <ul className="profile-info-list">
                        ...
                        <li>
                            ...
                            <div className="value">C++, PHP, HTML5, CSS, jQuery, MYSQL, Ionic, Laravel, Phonegap, Bootstrap, Angular JS, Angular JS, Asp.net</div>
                        </li>
                        <li>
