						...
						<div className="col-lg-8 col-xl-7 col-xxl-6">
							<div className="my-5 text-center text-xl-start">
								<h1 className="display-5 fw-bolder text-white mb-2">
									MEDIA Matrix - NFT Library for buying, distributing and managing media.
								</h1>
								<p className="lead fw-normal text-white-50 mb-4">
									Browse several categories of digital media for business and personal use. 
								</p>
					...
					<div className="row gx-5">
						<div className="col-lg-4 mb-5 mb-lg-0">
							<h2 className="fw-bolder mb-0">
								Take control of your art by following the journey and creating the rules.
							</h2>
						</div>
						<div className="col-lg-8">
							<div className="row gx-5 row-cols-1 row-cols-md-2">
								<div className="col mb-5 h-100">
									...
									<h2 className="h5">Featured Artist</h2>
									<p className="mb-0">
								...
								<div className="col mb-5 h-100">
									...
									<h2 className="h5">Featured Photographer</h2>
									<p className="mb-0">
										Paragraph of text beneath the heading to explain the
										heading. Here is just a bit more text.
									</p>
								...
								<div className="col mb-5 mb-md-0 h-100">
									...
									<h2 className="h5">Featured Musician</h2>
									<p className="mb-0">
										Paragraph of text beneath the heading to explain the
										heading. Here is just a bit more text.
									</p>
								...
								<div className="col h-100">
									...
									<h2 className="h5">Featured Producer</h2>
									<p className="mb-0">
										Paragraph of text beneath the heading to explain the
										heading. Here is just a bit more text.
									</p>
						...
						<div className="col-lg-10 col-xl-7">
							<div className="text-center">
								<div className="fs-4 mb-4 fst-italic">
									"Media Matrix has provided a platform where I can easily manage and distribute my own work!"
								</div>
					...
					<div className="row align-items-center justify-content-between flex-column flex-sm-row">
						<div className="col-auto">
							<div className="small m-0 text-white">
								Copyright &copy; Media Matrix - An NFT Library 2022
							</div>
						</div>
						<div className="col-auto">
